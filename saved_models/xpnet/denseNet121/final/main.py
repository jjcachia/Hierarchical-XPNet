...
def main():
    ...
    {'params': model.add_on_layers_module.parameters(), 'lr': warm_optimizer_lrs['add_on_layers'], 'weight_decay': 1e-3},
    ...
    {'params': model.add_on_layers_module.parameters(), 'lr':1e-4, 'weight_decay': 1e-3},
    ...
    last_layer_optimizer_specs = [{'params': model.task_specific_classifier.parameters(), 'lr': last_layer_optimizer_lr['task_specific_classifier']},
                                 ...
                                 {'params': model.final_add_on_layers.parameters(), 'lr': last_layer_optimizer_lr['final_classifier']}]
